...
<body style="padding-bottom: 20px">
    ...
    $sql = "SELECT ft_suiche.*, activos_fijos.activo_fijo FROM ft_suiche INNER JOIN activos_fijos 
    ON activos_fijos.id=ft_suiche.id_activo_fijo WHERE ft_suiche.id = $id";
    ...
    <div class="container">
        <div class="titulos">
            <div class="reedireccion" style="text-align: right;"><a class="salida" href="ver_routers.php">X</a>
            </div>
            <h1>Editar Router/Suiche</h1>
        </div>
        <!--Formulario de edición-->
        <div class="card edicion">

            <form action="registrar_actualizacion_router.php" method="post">
                ...
                <div class="row informacion">
                    ...
                    <div class="form-group col-md-2">
                            <label class="descripcion" for="first-name">Banda:</label>
                            <input type="text" class="form-control" name="banda" value="<?php echo $ficha['banda']; ?>">
                    </div>  
