...
<body style="margin-bottom: 20px;">
    ...
    <div class="container">
        ...
        <div class="row tipo">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="./crear_router.php"> Agregar </a>
                </div>
                ...
                <?php 
                   $sql = "SELECT  ft_suiche.*, activos_fijos.activo_fijo,  area.nombre, localizaciones.localizacion
                   FROM ft_suiche LEFT JOIN activos_fijos ON ft_suiche.id_activo_fijo = activos_fijos.id 
                   LEFT JOIN localizaciones ON activos_fijos.id_localizacion = localizaciones.id 
                   LEFT JOIN area ON localizaciones.id_area =area.id";
               ...
               switch($estados) {
                        ...
                        case 0:
                                // inactivos
                            $sql = $sql . " WHERE ft_suiche.estado = '0'";
                            break;
                        case 1;
                            // activos
                            $sql = $sql . " WHERE ft_suiche.estado = '1'";
                            break;
                       
                        case 2;
                            // retirados
                            $sql = $sql . " WHERE ft_suiche.estado = '2'";
                            break;
                    }
                ...
                <tbody>
                    ...
                    while ($f = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td class="orden-dato"><?php echo $f['puertos'] ?></td>
                            <td class="text-center" style="vertical-align: middle;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-secondary btn-sm" type="button" href="ficha_tecnica_router.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-search"></i></a>
                                </td>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                <a class="btn btn-primary btn-sm" type="button" href="editar_router.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-edit"></i></a>
                                </td>
...
function validar(estados){
    window.location = "ver_routers.php?estados="+estados;
}
</script>