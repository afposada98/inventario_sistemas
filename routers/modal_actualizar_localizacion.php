...
$sql = "SELECT ft_suiche.id_activo_fijo, activos_fijos.activo_fijo FROM ft_suiche INNER JOIN activos_fijos ON 
        ft_suiche.id_activo_fijo = activos_fijos.id WHERE ft_suiche.id = '$id_teclado'";
...
<div class="card mx-auto" style="width: 25rem; text-align:center; margin-top:5em;">
 <h5 class="card-header"><?=$activo_fijo?></h5>
  <div class="card-body">
    <h5 class="card-title">Actualiza la localizacion del router</h5>
 
    <form action="registrar-localizacion-router.php" class="form-group">
            <div>
