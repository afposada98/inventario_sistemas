...
<body style="padding-bottom: 30px">
    ...
    <div class="container" style="width:100%;">
        <div class="titulos">
            <div class="reedireccion" style="text-align: right;"><a class="salida" style=" text-decoration:none;" href="./ver_radioenlaces.php">X</a>
            </div>
            <h1>Crear Radioenlace</h1>
        </div>
        ...
        <form action="registrar_radioenlace.php" method="post">
            ...
            <div class="row informacion">
                ...
                <div class="form-group col-md-2">
                        ...
                        <select class="form-select" id="inputGroupSelect01" name="activoFijo" required>
                            ...
                            activos_fijos.estado=1 AND activos_fijos.id_tipo_activo=7
                ...
                <div class="form-group col-md-2">
                        <label class="descripcion">Referencia:</label>
