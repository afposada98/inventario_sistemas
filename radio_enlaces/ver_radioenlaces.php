...
<body style="margin-bottom: 20px;">
    ...
    <div class="container">
        ...
        <div class="row tipo">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="./crear_radioenlace.php"> Agregar </a>
                </div>
                ...
                <?php 
                   $sql = "SELECT  ft_radioenlace.*, activos_fijos.activo_fijo,  area.nombre, localizaciones.localizacion
                   FROM ft_radioenlace LEFT JOIN activos_fijos ON ft_radioenlace.id_activo_fijo = activos_fijos.id 
               ...
               switch($estados) {
                        ...
                        case 0:
                                // inactivos
                            $sql = $sql . " WHERE ft_radioenlace.estado = '0'";
                            break;
                        case 1;
                            // activos
                            $sql = $sql . " WHERE ft_radioenlace.estado = '1'";
                            break;
                       
                        case 2;
                            // retirados
                            $sql = $sql . " WHERE ft_radioenlace.estado = '2'";
                            break;
                    }
                    ...
                    while ($f = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-secondary btn-sm" type="button" href="ficha_tecnica_radioenlace.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-search"></i></a>
                                </td>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                <a class="btn btn-primary btn-sm" type="button" href="editar_radioenlace.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-edit"></i></a>
                                </td>
...
function validar(estados){
    window.location = "ver_radioenlaces.php?estados="+estados;
}
</script>