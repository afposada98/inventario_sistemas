...
$sql = "SELECT ft_radioenlace.id_activo_fijo, activos_fijos.activo_fijo FROM ft_radioenlace INNER JOIN activos_fijos ON 
        ft_radioenlace.id_activo_fijo = activos_fijos.id WHERE ft_radioenlace.id = '$id_teclado'";
...
<div class="card mx-auto" style="width: 25rem; text-align:center; margin-top:5em;">
 <h5 class="card-header"><?=$activo_fijo?></h5>
  <div class="card-body">
    <h5 class="card-title">Actualiza la localizacion del radio enlace</h5>
 
    <form action="registrar-localizacion-radioenlace.php" class="form-group">
            <div>
