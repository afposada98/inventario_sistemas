...
$sql = "UPDATE ft_radioenlace SET  marca = '$marca', modelo = '$modelo', serie = '$serie', puertos = '$puertos', velocidad = '$velocidad',
referencia = '$referencia', direccion_mac = '$mac', nombre = '$nombre', version_firmware = '$firmware', id_proveedor = '$proveedor', factura = '$factura',
