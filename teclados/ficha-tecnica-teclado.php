...
<body style="padding-bottom: 20px">
    ...
    <div class="container">
        <div class="titulos">
            <div class="reedireccion"><a class="salida" href="./ver-teclados.php">X</a></div>
            <div>
        ...
        <div class="card">
            <div class="row informacion">
                ...
                <div class="text-center">
                    <a type="button" href="ver-teclados.php" style="margin-top:10px;" class="btn btn-danger">Volver Atrás</a>
                </div>
