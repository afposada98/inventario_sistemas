...
$sql = "SELECT ft_tablet.id_activo_fijo, activos_fijos.activo_fijo FROM ft_tablet INNER JOIN activos_fijos ON 
        ft_tablet.id_activo_fijo = activos_fijos.id WHERE ft_tablet.id = '$id_teclado'";
...
<div class="card mx-auto" style="width: 25rem; text-align:center; margin-top:5em;">
 <h5 class="card-header"><?=$activo_fijo?></h5>
  <div class="card-body">
    <h5 class="card-title">Actualiza la localizacion de la tablet</h5>
 
    <form action="registrar-localizacion-tablet.php" class="form-group">
            <div>
