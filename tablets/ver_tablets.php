...
<body style="margin-bottom: 20px;">
    ...
    <div class="container">
        ...
        <div class="row tipo">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="./crear_tablet.php"> Agregar </a>
                </div>
                ...
                <?php 
                   $sql = "SELECT  ft_tablet.*, activos_fijos.activo_fijo,  area.nombre, localizaciones.localizacion
                   FROM ft_tablet LEFT JOIN activos_fijos ON ft_tablet.id_activo_fijo = activos_fijos.id 
               ...
               switch($estados) {
                        ...
                        case 0:
                                // inactivos
                            $sql = $sql . " WHERE ft_tablet.estado = '0'";
                            break;
                        case 1;
                            // activos
                            $sql = $sql . " WHERE ft_tablet.estado = '1'";
                            break;
                       
                        case 2;
                            // retirados
                            $sql = $sql . " WHERE ft_tablet.estado = '2'";
                            break;
                    }
                    ...
                    while ($f = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-secondary btn-sm" type="button" href="ficha_tecnica_tablet.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-search"></i></a>
                                </td>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                <a class="btn btn-primary btn-sm" type="button" href="editar_tablet.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-edit"></i></a>
                                </td>
...
function validar(estados){
    window.location = "ver_tablets.php?estados="+estados;
}
</script>