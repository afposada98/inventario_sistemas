...
<body style="margin-bottom: 20px;" >
    ...
    <div class="container">
        ...
        <div class="row tipo">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="./crear_impresora.php"> Agregar </a>
                </div>
                ...
                <?php 
                   $sql = "SELECT  ft_impresora.*, activos_fijos.activo_fijo,  area.nombre, localizaciones.localizacion
                   FROM ft_impresora LEFT JOIN activos_fijos ON 
                   ft_impresora.id_activo_fijo = activos_fijos.id LEFT JOIN localizaciones ON activos_fijos.id_localizacion = localizaciones.id LEFT JOIN area ON localizaciones.id_area = area.id ";
               ...
               switch($estados) {
                        ...
                        case 0:
                                // inactivos
                            $sql = $sql . "WHERE ft_impresora.estado = '0'";
                            break;
                        case 1;
                            // activos
                            $sql = $sql . "WHERE ft_impresora.estado = '1'";
                            break;
                       
                        case 2;
                            // retirados
                            $sql = $sql . "WHERE ft_impresora.estado = '2'";
                            break;
                    }
                ...
                <tbody>
                    ...
                    while ($f = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td class="orden-dato"><?php echo $f['tipo'] ?></td>
                            <td class="text-center" style="vertical-align: middle;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-secondary btn-sm" type="button" href="ficha_tecnica_impresora.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-search"></i></a>
                                </td>
                                <?php if ($perfil == 3) { ?>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                <a class="btn btn-primary btn-sm" type="button" href="editar_impresora.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-edit"></i></a>
                                </td>
...
function validar(estados){
    window.location = "ver_impresoras.php?estados="+estados;
}
</script>