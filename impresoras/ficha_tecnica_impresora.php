...
<body style="padding-bottom: 30px">
    ...
    <div class="container">
        <div class="titulos">
            <div class="reedireccion" style="text-align: right;"><a class="salida" href="./ver_impresoras.php">X</a></div>
        ...
        <div class="card">
            <div class="row informacion">
                ...
                <div class="text-center">
                    <a type="button" href="ver_impresoras.php" class="btn btn-danger">Volver Atrás</a>
                </div>
