...
<body style="padding-bottom: 20px">
    ...
    <div class="container">
        <div class="titulos">
            <div class="reedireccion" style="text-align: right;"><a class="salida" href="./ver-mouses.php">X</a></div>
            <div>
        ...
        <div class="card">
            <div class="row informacion">
                ...
                <div class="text-center">
                    <a type="button" href="ver-mouses.php" style="margin-top:10px;" class="btn btn-danger">Volver Atrás</a>
                </div>
