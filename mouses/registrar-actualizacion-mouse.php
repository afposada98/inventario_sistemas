...
$sql = $sql = "UPDATE ft_mouse SET id_activo_fijo = '$activoFijo', marca = '$marca', modelo = '$modelo', serie = '$serie', factura = '$factura',
factura = '$factura', fecha_compra = '$fecha_compra', tipo_conector = '$tipo_conector',
 id_proveedor = '$proveedor', observaciones = '$observaciones', estado = '$estado' WHERE id = '$id'";
