...
<body style="padding-bottom: 20px">
    ...
    <div class="container">
        ...
        <form class="row informacion" action="registrar-mouse.php" method="post">
            ...
            <div class="form-group col-md-3">
                ...
                <input type="" class="form-control" name="marca" placeholder="Marca del mouse" id="">
            </div>

            <div class="form-group col-md-3">
                <label class="descripcion" for="number">Modelo</label>
                <input type="text" class="form-control" name="modelo" placeholder="Modelo del mouse" id="number">
            </div>

            <div class="form-group col-md-3">
                <label class="descripcion" for="number">Serie</label>
                <input type="text" class="form-control" name="serie" placeholder="Serie del mouse" id="number">
            </div>

            <div class="form-group col-md-3">
                <label class="descripcion" for="country">Factura</label>
                <input type="text" class="form-control" name="factura" placeholder="Factura del mouse" id="country">
            </div>

            <div class="form-group col-md-3">
                <label class="descripcion" for="country">Fecha de la compra</label>
                <input type="date" class="form-control" name="fecha_compra" placeholder="Fecha de la compra del mouse" id="country">
            </div>

            <div class="form-group col-md-3">
                <label class="descripcion" for="">Tipo de conector</label>
                <select class="form-select" name="tipo_conector" placeholder="Tipo de conector del mouse" id="">
            ...
            <div class="form-group col-md-12">
                <label class="descripcion">Observaciones</label>
