...
<body style="padding-bottom: 20px">
    ...
    <div class="container">
        ...
        <div class="row tipo">
                <div class="col-md-2">
                    <a class="btn btn-primary" href="./crear-mouse.php"> Agregar </a>
                </div>
        ...
        <div class="container">
            ...
            <table id="example2" class="table display compact table-bordered"  cellpadding='0' $().DataTable();. style="width: 100%; ">
                ...
                <tbody>
                    ...
                    $sql = "SELECT ft_mouse.id, activos_fijos.activo_fijo, area.nombre, localizaciones.localizacion, ft_mouse.marca, ft_mouse.modelo, ft_mouse.serie, 
                    ft_mouse.tipo_conector, ft_mouse.estado FROM ft_mouse LEFT JOIN activos_fijos ON 
                    ft_mouse.id_activo_fijo = activos_fijos.id LEFT JOIN localizaciones ON  activos_fijos.id_localizacion = localizaciones.id LEFT JOIN area ON localizaciones.id_area = area.id ";
                   ...
                   switch($estados) {
                        ...
                        case 0:
                                // inactivos
                            $sql = $sql . "WHERE ft_mouse.estado = '0'";
                            break;
                        case 1;
                            // activos
                            $sql = $sql . "WHERE ft_mouse.estado = '1'";
                            break;
                       
                        case 2;
                            // retirados
                            $sql = $sql . "WHERE ft_mouse.estado = '2'";
                            break;
                    }
                    ...
                    while ($f = mysqli_fetch_array($query)) {     ?>
                        <tr>
                            ...
                            <td class="text-center" style="vertical-align: middle;">
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    <a class="btn btn-secondary btn-sm" type="button" href="ficha-tecnica-mouse.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-search"></i></a>
                                </td>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                <a class="btn btn-primary btn-sm" type="button" href="editar-mouse.php?id=<?php echo $f['id'] ?>" style="font-size: 17px;border-radius:8px 3px;"><i class="fas fa-edit"></i></a>
                                </td>
...
<!-- <script>
    function mensaje_desactivar(id_mouse) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed, result.value) {
                ...
                window.location = "desactivar-mouse.php?id=" + id_mouse + "&justificacion=" + result.value;
...
<script type="text/javascript">
    ...
    function validar(estados){
        window.location = "ver-mouses.php?estados="+estados;
    }
</script>
