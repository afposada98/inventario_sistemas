...
$id_mouse = $_REQUEST['id'];


$sql = "SELECT ft_mouse.id_activo_fijo, activos_fijos.activo_fijo FROM ft_mouse INNER JOIN activos_fijos 
        ON ft_mouse.id_activo_fijo = activos_fijos.id WHERE ft_mouse.id = '$id_mouse'";
...
<div class="card mx-auto" style="width: 25rem; text-align:center; margin-top:5em;">
 <h5 class="card-header"><?=$activo_fijo?></h5>
  <div class="card-body">
    <h5 class="card-title">Actualiza la localizacion del mouse</h5>
 
    <form action="registrar-localizacion-mouse.php" class="form-group">
            <div>
