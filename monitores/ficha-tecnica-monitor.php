...
<body style="padding-bottom: 20px">
    ...
    <div class="container">
        <div class="titulos">
            <div class="reedireccion"><a class="salida" href="./ver-monitor.php">X</a></div>
        ...
        <div class="text-center">
            <a type="button" href="ver-monitor.php" style="margin:10px;" class="btn btn-danger">Volver Atrás</a>
        </div>
